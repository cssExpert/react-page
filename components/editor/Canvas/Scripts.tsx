...
const Scripts = () => {
  return (
    <>
      <SectionTitle
        title="Scripts"
        paragraph="Add custom JavaScript from an external file or paste it inline."
      />
            ...
            <Field className="flex flex-col items-end justify-end shrink-0 relative w-40">
              ...
              <Select>
                ...
                <SelectContent className="rounded-sm">
                  <SelectGroup>
                    <SelectItem value="apple">in &lt;head&gt;</SelectItem>
                    <SelectItem value="banana">before &lt;/body&gt;</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
            </Field>
            ...
            <div className="flex-1 flex flex-col gap-3">
              <div className="relative">
                <Textarea
                  rows={4}
                  id="html-js-code"
                  placeholder="Please enter your JavaScript code. Do not include <script> tag here."
                  className={inputCls + " resize-none h-full pr-12"}
                />
              </div>
              ...
              <div className="flex flex-col gap-2.5 mt-1">
                <FieldGroup className="mx-0 gap-0 space-y-2.5">
                  ...
                  <Field orientation="horizontal" className="items-center">
                    <Checkbox
                      id="checkbox-skip-editor"
                      name="checkbox-skip-editor"
                      className="peer w-5 h-5 rounded border-slate-300 dark:border-white/20 text-indigo-600 focus:ring-indigo-500 bg-transparent data-checked:bg-indigo-500 dark:data-checked:bg-[#CEFF00] dark:data-checked:border-[#323232]"
                    />
                    <FieldLabel htmlFor="checkbox-skip-editor">
                      Skip loading this script in the editor.
                    </FieldLabel>
                  </Field>
                </FieldGroup>
              </div>
